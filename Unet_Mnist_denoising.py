...
'''
    ...
    conv12 = Conv2D(1, 1, activation = 'sigmoid')(conv10)
...
model2.summary()
#model2.fit(x = x_train_noisy, y = x_train_new , batch_size= batch_size  ,epochs = epochs, validation_data = (x_test_noisy, x_test_new ), verbose=1)